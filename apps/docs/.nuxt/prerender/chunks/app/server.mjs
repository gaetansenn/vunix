import { getCurrentInstance, toRef, isRef, inject, ref, defineAsyncComponent, unref, getCurrentScope, onScopeDispose, nextTick, defineComponent, h, computed, Text, resolveComponent, useSSRContext, watch, useSlots, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, createCommentVNode, toDisplayString, createElementBlock, Suspense, Transition, provide, reactive, createTextVNode, shallowRef, createElementVNode, Fragment as Fragment$1, renderList, createApp, onErrorCaptured, watchEffect } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/ohmyfetch/dist/node.mjs';
import { withoutTrailingSlash, withLeadingSlash, joinURL, hasProtocol, withBase, isEqual as isEqual$1, parseURL } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/ufo/dist/index.mjs';
import { createHooks } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/unctx/dist/index.mjs';
import destr from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/destr/dist/index.mjs';
import { appendHeader, createError as createError$1, sendRedirect } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/nitropack/node_modules/h3/dist/index.mjs';
import { defuFn } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/defu/dist/defu.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/vue-router/dist/vue-router.node.mjs';
import { pascalCase } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/scule/dist/index.mjs';
import { find, html } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/property-information/index.js';
import htmlTags from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/html-tags/index.js';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderSlot, ssrRenderList, ssrRenderClass, ssrRenderTeleport, ssrRenderAttr, ssrRenderSuspense } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/vue/server-renderer/index.mjs';
import { Icon as Icon$1 } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/@iconify/vue/dist/offline.mjs';
import { loadIcon } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/@iconify/vue/dist/iconify.mjs';
import { hash, isEqual } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/ohash/dist/index.mjs';
import { parse, serialize } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/cookie-es/dist/index.mjs';
import { plugin } from 'file:///Users/gaetansenn/Development/dewib/librairies/ui/node_modules/pinceau/dist/runtime.mjs';
...
const components = {
  Ellipsis: defineAsyncComponent(() => import('./_nuxt/Ellipsis.5383dbb1.mjs').then((c) => c.default || c)),
  IconMarkdown: defineAsyncComponent(() => import('./_nuxt/IconMarkdown.01816ef9.mjs').then((c) => c.default || c)),
  Alert: defineAsyncComponent(() => Promise.resolve().then(() => Alert).then((c) => c.default || c)),
  ArticleHero: defineAsyncComponent(() => import('./_nuxt/ArticleHero.6870405d.mjs').then((c) => c.default || c)),
  Badge: defineAsyncComponent(() => import('./_nuxt/Badge.5ffc7c46.mjs').then((c) => c.default || c)),
  BlockHero: defineAsyncComponent(() => import('./_nuxt/BlockHero.3267b2ff.mjs').then((c) => c.default || c)),
  ButtonLink: defineAsyncComponent(() => Promise.resolve().then(() => ButtonLink).then((c) => c.default || c)),
  Callout: defineAsyncComponent(() => import('./_nuxt/Callout.c24dcc1c.mjs').then((c) => c.default || c)),
  Card: defineAsyncComponent(() => import('./_nuxt/Card.96e7f462.mjs').then((c) => c.default || c)),
  CardGrid: defineAsyncComponent(() => import('./_nuxt/CardGrid.b495f136.mjs').then((c) => c.default || c)),
  CodeBlock: defineAsyncComponent(() => import('./_nuxt/CodeBlock.f6a823be.mjs').then((c) => c.default || c)),
  CodeGroup: defineAsyncComponent(() => import('./_nuxt/CodeGroup.c3d79e8a.mjs').then((c) => c.default || c)),
  CopyButton: defineAsyncComponent(() => import('./_nuxt/CopyButton.27fa6c2b.mjs').then((c) => c.default || c)),
  Icon: defineAsyncComponent(() => Promise.resolve().then(() => Icon).then((c) => c.default || c)),
  List: defineAsyncComponent(() => import('./_nuxt/List.4823f5dc.mjs').then((c) => c.default || c)),
  NuxtImg: defineAsyncComponent(() => import('./_nuxt/NuxtImg.7faf3ed8.mjs').then((c) => c.default || c)),
  Props: defineAsyncComponent(() => import('./_nuxt/Props.a395be00.mjs').then((c) => c.default || c)),
  Sandbox: defineAsyncComponent(() => import('./_nuxt/Sandbox.58ee4ace.mjs').then((c) => c.default || c)),
  SourceLink: defineAsyncComponent(() => import('./_nuxt/SourceLink.3a0990ae.mjs').then((c) => c.default || c)),
  TabsHeader: defineAsyncComponent(() => import('./_nuxt/TabsHeader.b936d4f5.mjs').then((c) => c.default || c)),
  Terminal: defineAsyncComponent(() => import('./_nuxt/Terminal.d2884076.mjs').then((c) => c.default || c)),
  VideoPlayer: defineAsyncComponent(() => import('./_nuxt/VideoPlayer.099feedf.mjs').then((c) => c.default || c)),
  ProseA: defineAsyncComponent(() => import('./_nuxt/ProseA.d9ca6d0a.mjs').then((c) => c.default || c)),
  ProseBlockquote: defineAsyncComponent(() => import('./_nuxt/ProseBlockquote.7bdbc509.mjs').then((c) => c.default || c)),
  ProseCode: defineAsyncComponent(() => import('./_nuxt/ProseCode.c920deed.mjs').then((c) => c.default || c)),
  ProseCodeInline: defineAsyncComponent(() => import('./_nuxt/ProseCodeInline.26bac34e.mjs').then((c) => c.default || c)),
  ProseEm: defineAsyncComponent(() => import('./_nuxt/ProseEm.ae5d5ff7.mjs').then((c) => c.default || c)),
  ProseH1: defineAsyncComponent(() => import('./_nuxt/ProseH1.8125c540.mjs').then((c) => c.default || c)),
  ProseH2: defineAsyncComponent(() => import('./_nuxt/ProseH2.773f78cc.mjs').then((c) => c.default || c)),
  ProseH3: defineAsyncComponent(() => import('./_nuxt/ProseH3.00cdde03.mjs').then((c) => c.default || c)),
  ProseH4: defineAsyncComponent(() => import('./_nuxt/ProseH4.874ae57e.mjs').then((c) => c.default || c)),
  ProseHr: defineAsyncComponent(() => import('./_nuxt/ProseHr.86ff0c36.mjs').then((c) => c.default || c)),
  ProseImg: defineAsyncComponent(() => import('./_nuxt/ProseImg.78eb44a5.mjs').then((c) => c.default || c)),
  ProseLi: defineAsyncComponent(() => import('./_nuxt/ProseLi.8627bf78.mjs').then((c) => c.default || c)),
  ProseOl: defineAsyncComponent(() => import('./_nuxt/ProseOl.1fd8426b.mjs').then((c) => c.default || c)),
  ProseP: defineAsyncComponent(() => import('./_nuxt/ProseP.37a41574.mjs').then((c) => c.default || c)),
  ProseStrong: defineAsyncComponent(() => import('./_nuxt/ProseStrong.423967f2.mjs').then((c) => c.default || c)),
  ProseTable: defineAsyncComponent(() => import('./_nuxt/ProseTable.c2816d52.mjs').then((c) => c.default || c)),
  ProseTbody: defineAsyncComponent(() => import('./_nuxt/ProseTbody.feb9de93.mjs').then((c) => c.default || c)),
  ProseTd: defineAsyncComponent(() => import('./_nuxt/ProseTd.865e905e.mjs').then((c) => c.default || c)),
  ProseTh: defineAsyncComponent(() => import('./_nuxt/ProseTh.f127ed32.mjs').then((c) => c.default || c)),
  ProseThead: defineAsyncComponent(() => import('./_nuxt/ProseThead.d561cfcb.mjs').then((c) => c.default || c)),
  ProseTr: defineAsyncComponent(() => import('./_nuxt/ProseTr.7d1bddd4.mjs').then((c) => c.default || c)),
  ProseUl: defineAsyncComponent(() => import('./_nuxt/ProseUl.860e08a6.mjs').then((c) => c.default || c)),
  PageContributors: defineAsyncComponent(() => import('./_nuxt/PageContributors.69cf98d5.mjs').then((c) => c.default || c)),
  PageEditLink: defineAsyncComponent(() => import('./_nuxt/PageEditLink.1457fe2a.mjs').then((c) => c.default || c)),
  Releases: defineAsyncComponent(() => import('./_nuxt/Releases.03c898f1.mjs').then((c) => c.default || c)),
  ReleasesReactions: defineAsyncComponent(() => import('./_nuxt/ReleasesReactions.09196a55.mjs').then((c) => c.default || c)),
  IconCodeSandBox: defineAsyncComponent(() => import('./_nuxt/IconCodeSandBox.b29c2ec5.mjs').then((c) => c.default || c)),
  IconDocus: defineAsyncComponent(() => import('./_nuxt/IconDocus.4d848cc2.mjs').then((c) => c.default || c)),
  IconNuxt: defineAsyncComponent(() => import('./_nuxt/IconNuxt.da363845.mjs').then((c) => c.default || c)),
  IconNuxtContent: defineAsyncComponent(() => import('./_nuxt/IconNuxtContent.4c2584c1.mjs').then((c) => c.default || c)),
  IconNuxtLabs: defineAsyncComponent(() => import('./_nuxt/IconNuxtLabs.bf6ff304.mjs').then((c) => c.default || c)),
  IconStackBlitz: defineAsyncComponent(() => import('./_nuxt/IconStackBlitz.f7f69ac9.mjs').then((c) => c.default || c)),
  IconVueTelescope: defineAsyncComponent(() => import('./_nuxt/IconVueTelescope.91de1f01.mjs').then((c) => c.default || c)),
  ContentDoc: defineAsyncComponent(() => import('./_nuxt/ContentDoc.da2d71e0.mjs').then((c) => c.default || c)),
  ContentList: defineAsyncComponent(() => import('./_nuxt/ContentList.94c8c73f.mjs').then((c) => c.default || c)),
  ContentNavigation: defineAsyncComponent(() => import('./_nuxt/ContentNavigation.8d3c9c62.mjs').then((c) => c.default || c)),
  ContentQuery: defineAsyncComponent(() => import('./_nuxt/ContentQuery.79eb4b5c.mjs').then((c) => c.default || c)),
  ...
  Markdown: defineAsyncComponent(() => import('./_nuxt/Markdown.e5c56f49.mjs').then((c) => c.default || c)),
  ProseH5: defineAsyncComponent(() => import('./_nuxt/ProseH5.29a7fa85.mjs').then((c) => c.default || c)),
  ProseH6: defineAsyncComponent(() => import('./_nuxt/ProseH6.eb9b8191.mjs').then((c) => c.default || c))
};
...
const layouts = {
  default: () => import('./_nuxt/default.2996ee46.mjs').then((m) => m.default || m),
  page: () => import('./_nuxt/page.fa3a6f29.mjs').then((m) => m.default || m)
};
...
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/content/Icon.vue");
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/content/ButtonLink.vue");
  return _sfc_setup$i ? _sfc_setup$i(props, ctx) : void 0;
};
const __nuxt_component_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-dd65f993"]]);
...
_sfc_main$h.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/DocumentDrivenNotFound.vue");
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    file: "/Users/gaetansenn/Development/dewib/librairies/ui/node_modules/@nuxt/content/dist/runtime/pages/document-driven.vue",
    children: [],
    meta,
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/document-driven.05629848.mjs').then((m) => m.default || m)
  }
];
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./_nuxt/client-db.4afa2677.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./_nuxt/client-db.4afa2677.mjs').then((m) => m.generateNavigation);
...
const ______node_modules__64nuxt_content_dist_runtime_plugins_documentDriven_mjs_ffYjUOrH9N = defineNuxtPlugin((nuxt) => {
  var _a, _b;
...
const ______node_modules__64nuxt_content_dist_runtime_plugins_ws_mjs_l0q1qsICMA = defineNuxtPlugin(() => {
  useRuntimeConfig().public;
});
const preference = "system";
const componentName = "ColorScheme";
const dataValue = "theme";
const ______node_modules__64nuxtjs_color_mode_dist_runtime_plugin_server_mjs_i74oE9MStO = defineNuxtPlugin((nuxtApp) => {
...
const theme$1 = { aliases, theme };
const _nuxt_pinceau_imports_mjs_8K3h7hEN4C = defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.use(plugin, { theme: theme$1, idStorage: (id, key) => useState(key, () => id), colorSchemeMode: "class" });
...
const ______node_modules__64nuxt_themes_docus_edge_plugins_menu_ts_q1ZkBXtOpk = defineNuxtPlugin((ctx) => {
...
const _plugins = [
  ...
  ______node_modules__64nuxt_content_dist_runtime_plugins_documentDriven_mjs_ffYjUOrH9N,
  ______node_modules__64nuxt_content_dist_runtime_plugins_ws_mjs_l0q1qsICMA,
  ______node_modules__64nuxtjs_color_mode_dist_runtime_plugin_server_mjs_i74oE9MStO,
  _nuxt_pinceau_imports_mjs_8K3h7hEN4C,
  ______node_modules__64nuxt_themes_docus_edge_plugins_menu_ts_q1ZkBXtOpk
];
const _sfc_main$g = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.124a9ee5.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/AppLoadingBar.vue");
...
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/AppContainer.vue");
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/SocialIcons.vue");
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/docs/DocsAsideTree.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/ColorModeSwitch.vue");
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/NavbarDialog.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/Logo.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/NavbarLogo.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(hasNavigation)) {
        _push(`<nav${ssrRenderAttrs(_attrs)} data-v-538c8cf4><ul class="flex items-center justify-center flex-1 max-w-full space-x-2 overflow-hidden font-medium truncate" data-v-538c8cf4><!--[-->`);
        ssrRenderList(unref(tree), (link) => {
          _push(`<li data-v-538c8cf4>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/NavbarCenter.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-538c8cf4"]]);
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/AppSearch.vue");
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SocialIcons = _sfc_main$d;
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-10 w-full border-b h-header u-border-gray-100 bg-white/80 dark:bg-black/80" }, _attrs))} data-v-c9ef9b4b>`);
      _push(ssrRenderComponent(_component_AppContainer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center flex-none col-span-2" data-v-c9ef9b4b${_scopeId}>`);
            ...
            _push2(`</div><div class="flex items-center justify-center flex-1 col-span-8" data-v-c9ef9b4b${_scopeId}>`);
            if (unref(hasNavbarDialog)) {
            ...
            _push2(`</div><div class="flex items-center justify-end flex-none col-span-2 lg:gap-4 lg:pl-4" data-v-c9ef9b4b${_scopeId}>`);
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/Navbar.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c9ef9b4b"]]);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/content/Alert.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/AppFooter.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/components/AppLayout.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/@nuxt-themes/docus-edge/app.vue");
...
export { AppLoadingBar as $, useRouter as A, _sfc_main$e as B, ContentSlot as C, _sfc_main$3 as D, useRequestEvent as E, __nuxt_component_0$2 as F, _sfc_main$l as G, __nuxt_component_3$1 as H, get as I, assertArray as J, ensureArray as K, sortList as L, apply as M, withoutKeys as N, withKeys as O, useCookie as P, createQuery as Q, nuxtLink as R, layout as S, ContentRendererMarkdown as T, ContentRenderer as U, DocumentDrivenEmpty as V, Icon as W, ContentSlot$1 as X, ButtonLink as Y, DocumentDrivenNotFound as Z, _export_sfc as _, __nuxt_component_1$3 as a, AppContainer as a0, SocialIcons as a1, DocsAsideTree as a2, clientOnly as a3, component_vue3 as a4, ColorModeSwitch as a5, NavbarDialog as a6, Logo as a7, NavbarLogo as a8, NavbarCenter as a9, AppSearch as aa, Navbar as ab, Alert as ac, AppFooter as ad, AppLayout as ae, page as af, useTimeoutFn as b, isString as c, tryOnMounted as d, entry$1 as default, identity as e, _sfc_main$k as f, useUnwrap as g, useNuxtApp as h, isClient as i, useColorMode as j, __nuxt_component_0$3 as k, useDocus as l, useRuntimeConfig as m, noop as n, _sfc_main$m as o, useRoute as p, useContentHead as q, resolveUnref as r, queryContent as s, tryOnScopeDispose as t, useContent as u, useHead as v, useState as w, fetchContentNavigation as x, useContentHelpers as y, _sfc_main$c as z };
