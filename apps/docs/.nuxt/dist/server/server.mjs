import { getCurrentInstance, reactive, toRef, isRef, inject, ref, defineComponent, computed, h, resolveComponent, defineAsyncComponent, unref, getCurrentScope, onScopeDispose, nextTick, watchEffect, Transition, Text, useSSRContext, watch, useSlots, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, createCommentVNode, createTextVNode, shallowRef, provide, onErrorCaptured, toDisplayString, createElementBlock, createElementVNode, Fragment as Fragment$1, renderList, Suspense, createApp } from "vue";
import { $fetch as $fetch$1 } from "ohmyfetch";
import { joinURL, hasProtocol, parseURL, withBase, withoutTrailingSlash, isEqual as isEqual$1, withLeadingSlash } from "ufo";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderSuspense, ssrRenderSlot, ssrRenderList, ssrRenderClass, ssrRenderTeleport, ssrRenderAttr } from "vue/server-renderer";
...
const _700 = "";
const components = {
  Ellipsis: defineAsyncComponent(() => import("./_nuxt/Ellipsis.5383dbb1.js").then((c) => c.default || c)),
  IconMarkdown: defineAsyncComponent(() => import("./_nuxt/IconMarkdown.01816ef9.js").then((c) => c.default || c)),
  Alert: defineAsyncComponent(() => Promise.resolve().then(() => Alert).then((c) => c.default || c)),
  ArticleHero: defineAsyncComponent(() => import("./_nuxt/ArticleHero.6870405d.js").then((c) => c.default || c)),
  Badge: defineAsyncComponent(() => import("./_nuxt/Badge.5ffc7c46.js").then((c) => c.default || c)),
  BlockHero: defineAsyncComponent(() => import("./_nuxt/BlockHero.3267b2ff.js").then((c) => c.default || c)),
  ButtonLink: defineAsyncComponent(() => Promise.resolve().then(() => ButtonLink).then((c) => c.default || c)),
  Callout: defineAsyncComponent(() => import("./_nuxt/Callout.c24dcc1c.js").then((c) => c.default || c)),
  Card: defineAsyncComponent(() => import("./_nuxt/Card.96e7f462.js").then((c) => c.default || c)),
  CardGrid: defineAsyncComponent(() => import("./_nuxt/CardGrid.b495f136.js").then((c) => c.default || c)),
  CodeBlock: defineAsyncComponent(() => import("./_nuxt/CodeBlock.f6a823be.js").then((c) => c.default || c)),
  CodeGroup: defineAsyncComponent(() => import("./_nuxt/CodeGroup.c3d79e8a.js").then((c) => c.default || c)),
  CopyButton: defineAsyncComponent(() => import("./_nuxt/CopyButton.27fa6c2b.js").then((c) => c.default || c)),
  Icon: defineAsyncComponent(() => Promise.resolve().then(() => Icon).then((c) => c.default || c)),
  List: defineAsyncComponent(() => import("./_nuxt/List.4823f5dc.js").then((c) => c.default || c)),
  NuxtImg: defineAsyncComponent(() => import("./_nuxt/NuxtImg.7faf3ed8.js").then((c) => c.default || c)),
  Props: defineAsyncComponent(() => import("./_nuxt/Props.a395be00.js").then((c) => c.default || c)),
  Sandbox: defineAsyncComponent(() => import("./_nuxt/Sandbox.58ee4ace.js").then((c) => c.default || c)),
  SourceLink: defineAsyncComponent(() => import("./_nuxt/SourceLink.3a0990ae.js").then((c) => c.default || c)),
  TabsHeader: defineAsyncComponent(() => import("./_nuxt/TabsHeader.b936d4f5.js").then((c) => c.default || c)),
  Terminal: defineAsyncComponent(() => import("./_nuxt/Terminal.d2884076.js").then((c) => c.default || c)),
  VideoPlayer: defineAsyncComponent(() => import("./_nuxt/VideoPlayer.099feedf.js").then((c) => c.default || c)),
  ProseA: defineAsyncComponent(() => import("./_nuxt/ProseA.d9ca6d0a.js").then((c) => c.default || c)),
  ProseBlockquote: defineAsyncComponent(() => import("./_nuxt/ProseBlockquote.7bdbc509.js").then((c) => c.default || c)),
  ProseCode: defineAsyncComponent(() => import("./_nuxt/ProseCode.c920deed.js").then((c) => c.default || c)),
  ProseCodeInline: defineAsyncComponent(() => import("./_nuxt/ProseCodeInline.26bac34e.js").then((c) => c.default || c)),
  ProseEm: defineAsyncComponent(() => import("./_nuxt/ProseEm.ae5d5ff7.js").then((c) => c.default || c)),
  ProseH1: defineAsyncComponent(() => import("./_nuxt/ProseH1.8125c540.js").then((c) => c.default || c)),
  ProseH2: defineAsyncComponent(() => import("./_nuxt/ProseH2.773f78cc.js").then((c) => c.default || c)),
  ProseH3: defineAsyncComponent(() => import("./_nuxt/ProseH3.00cdde03.js").then((c) => c.default || c)),
  ProseH4: defineAsyncComponent(() => import("./_nuxt/ProseH4.874ae57e.js").then((c) => c.default || c)),
  ProseHr: defineAsyncComponent(() => import("./_nuxt/ProseHr.86ff0c36.js").then((c) => c.default || c)),
  ProseImg: defineAsyncComponent(() => import("./_nuxt/ProseImg.78eb44a5.js").then((c) => c.default || c)),
  ProseLi: defineAsyncComponent(() => import("./_nuxt/ProseLi.8627bf78.js").then((c) => c.default || c)),
  ProseOl: defineAsyncComponent(() => import("./_nuxt/ProseOl.1fd8426b.js").then((c) => c.default || c)),
  ProseP: defineAsyncComponent(() => import("./_nuxt/ProseP.37a41574.js").then((c) => c.default || c)),
  ProseStrong: defineAsyncComponent(() => import("./_nuxt/ProseStrong.423967f2.js").then((c) => c.default || c)),
  ProseTable: defineAsyncComponent(() => import("./_nuxt/ProseTable.c2816d52.js").then((c) => c.default || c)),
  ProseTbody: defineAsyncComponent(() => import("./_nuxt/ProseTbody.feb9de93.js").then((c) => c.default || c)),
  ProseTd: defineAsyncComponent(() => import("./_nuxt/ProseTd.865e905e.js").then((c) => c.default || c)),
  ProseTh: defineAsyncComponent(() => import("./_nuxt/ProseTh.f127ed32.js").then((c) => c.default || c)),
  ProseThead: defineAsyncComponent(() => import("./_nuxt/ProseThead.d561cfcb.js").then((c) => c.default || c)),
  ProseTr: defineAsyncComponent(() => import("./_nuxt/ProseTr.7d1bddd4.js").then((c) => c.default || c)),
  ProseUl: defineAsyncComponent(() => import("./_nuxt/ProseUl.860e08a6.js").then((c) => c.default || c)),
  PageContributors: defineAsyncComponent(() => import("./_nuxt/PageContributors.69cf98d5.js").then((c) => c.default || c)),
  PageEditLink: defineAsyncComponent(() => import("./_nuxt/PageEditLink.1457fe2a.js").then((c) => c.default || c)),
  Releases: defineAsyncComponent(() => import("./_nuxt/Releases.03c898f1.js").then((c) => c.default || c)),
  ReleasesReactions: defineAsyncComponent(() => import("./_nuxt/ReleasesReactions.09196a55.js").then((c) => c.default || c)),
  IconCodeSandBox: defineAsyncComponent(() => import("./_nuxt/IconCodeSandBox.b29c2ec5.js").then((c) => c.default || c)),
  IconDocus: defineAsyncComponent(() => import("./_nuxt/IconDocus.4d848cc2.js").then((c) => c.default || c)),
  IconNuxt: defineAsyncComponent(() => import("./_nuxt/IconNuxt.da363845.js").then((c) => c.default || c)),
  IconNuxtContent: defineAsyncComponent(() => import("./_nuxt/IconNuxtContent.4c2584c1.js").then((c) => c.default || c)),
  IconNuxtLabs: defineAsyncComponent(() => import("./_nuxt/IconNuxtLabs.bf6ff304.js").then((c) => c.default || c)),
  IconStackBlitz: defineAsyncComponent(() => import("./_nuxt/IconStackBlitz.f7f69ac9.js").then((c) => c.default || c)),
  IconVueTelescope: defineAsyncComponent(() => import("./_nuxt/IconVueTelescope.91de1f01.js").then((c) => c.default || c)),
  ContentDoc: defineAsyncComponent(() => import("./_nuxt/ContentDoc.da2d71e0.js").then((c) => c.default || c)),
  ContentList: defineAsyncComponent(() => import("./_nuxt/ContentList.94c8c73f.js").then((c) => c.default || c)),
  ContentNavigation: defineAsyncComponent(() => import("./_nuxt/ContentNavigation.8d3c9c62.js").then((c) => c.default || c)),
  ContentQuery: defineAsyncComponent(() => import("./_nuxt/ContentQuery.79eb4b5c.js").then((c) => c.default || c)),
  ...
  Markdown: defineAsyncComponent(() => import("./_nuxt/Markdown.e5c56f49.js").then((c) => c.default || c)),
  ProseH5: defineAsyncComponent(() => import("./_nuxt/ProseH5.29a7fa85.js").then((c) => c.default || c)),
  ProseH6: defineAsyncComponent(() => import("./_nuxt/ProseH6.eb9b8191.js").then((c) => c.default || c))
};
...
const layouts = {
  default: () => import("./_nuxt/default.2996ee46.js").then((m) => m.default || m),
  page: () => import("./_nuxt/page.fa3a6f29.js").then((m) => m.default || m)
};
...
const ButtonLink_vue_vue_type_style_index_0_scoped_dd65f993_lang = "";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/document-driven.05629848.js").then((m) => m.default || m)
  }
];
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./_nuxt/client-db.4afa2677.js").then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./_nuxt/client-db.4afa2677.js").then((m) => m.generateNavigation);
...
const _sfc_main$g = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.124a9ee5.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const NavbarCenter_vue_vue_type_style_index_0_scoped_538c8cf4_lang = "";
...
const Navbar_vue_vue_type_style_index_0_scoped_c9ef9b4b_lang = "";
...
export {
  ...
  nuxtLink as R,
  layout as S,
  ContentRendererMarkdown as T,
  ContentRenderer as U,
  DocumentDrivenEmpty as V,
  Icon as W,
  ContentSlot$1 as X,
  ButtonLink as Y,
  DocumentDrivenNotFound as Z,
  _export_sfc as _,
  __nuxt_component_1$3 as a,
  AppContainer as a0,
  SocialIcons as a1,
  DocsAsideTree as a2,
  clientOnly as a3,
  component_vue3 as a4,
  ColorModeSwitch as a5,
  NavbarDialog as a6,
  Logo as a7,
  NavbarLogo as a8,
  NavbarCenter as a9,
